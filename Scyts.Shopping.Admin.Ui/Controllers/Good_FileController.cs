...
{
    public class Good_FileController : Controller
    {
        // GET: Good_File
        ...
        {
            var bs = Bll.BsProvider.CreateBusiness<Bll.IGood_File>();
            int totalCount = 0;
        ...
        [ValidateInput(false)]
        [HttpPost]
        public string Save(Bll.ViewModel.ViewModel_Good_File model,Model.File a_model)
        {
            ...
            //编辑
              ...
              var abs=  Bll.BsProvider.CreateBusiness<Bll.IFile>();
